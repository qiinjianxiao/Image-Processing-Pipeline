function green = green_interpolation_ARI(mosaic, mask, pattern, eps,itnum)
...
clear Guiderh Guidebh Guiderv Guidebv
...
clear Guidegrv Guidegbv Guiderv Guidegbv
...
for ittime = 1:itnum	
    ...
    clear RI_residualGrh RI_residualGbh RI_residualRh RI_residualBh
    clear RI_residualGrv RI_residualGbv RI_residualRv RI_residualBv
    clear MLRI_residualGrh MLRI_residualGbh MLRI_residualRh MLRI_residualBh
    clear MLRI_residualGrv MLRI_residualGbv MLRI_residualRv MLRI_residualBv
    ...
    clear RI_Guidegrh RI_Guidegbh RI_Guiderh RI_Guidebh
    clear RI_Guidegrv RI_Guidegbv RI_Guiderv RI_Guidebv MLRI_Guidegbh MLRI_Guiderh MLRI_Guidebh
    clear MLRI_Guidegrh MLRI_Guidegbh MLRI_Guiderh MLRI_Guidebh
    clear MLRI_Guidegrv MLRI_Guidegbv MLRI_Guiderv MLRI_Guidebv
    clear RI_tentativeGrh RI_tentativeGbh RI_tentativeRh RI_tentativeBh
    clear RI_tentativeGrv RI_tentativeGbv RI_tentativeRv RI_tentativeBv
    clear MLRI_tentativeGrh MLRI_tentativeGbh MLRI_tentativeRh MLRI_tentativeBh
    clear MLRI_tentativeGrv MLRI_tentativeGbv MLRI_tentativeRv MLRI_tentativeBv
    ...
    clear RI_criGrh RI_criGbh RI_criGrv RI_criGbv
    clear RI_criRh RI_criBh RI_criRv RI_criBv 
    clear MLRI_criGrh MLRI_criGbh MLRI_criGrv MLRI_criGbv
    clear MLRI_criRh MLRI_criBh MLRI_criRv MLRI_criBv
    ...
    clear MLRI_difcriGrh MLRI_difcriGbh MLRI_difcriGrv MLRI_difcriGbv
    clear MLRI_difcriRh MLRI_difcriBh MLRI_difcriRv MLRI_difcriBv
    clear RI_difcriGrh RI_difcriGbh RI_difcriGrv RI_difcriGbv
    clear RI_difcriRh RI_difcriBh RI_difcriRv RI_difcriBv
    ...
    clear RI_crih RI_criv MLRI_crih MLRI_criv
    clear RI_difcrih RI_difcriv MLRI_difcrih MLRI_difcriv
    ...
    clear RI_pih RI_piv MLRI_pih MLRI_piv
    clear RI_wh RI_wv MLRI_wh MLRI_wv
